        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-7 pages">
                    <div class="list-menu">
                        <h2 class="pagetitle">الأسئلة الشائعة</h2>
                        <ul>
                            <li><a class="active" href="index.html">الرئيسية <span class="inActive">/</span></a></li>
                            <li><a class="inActive">الأسئلة الشائعة</a></li>
                        </ul>
                    </div> <!-- /.list-menu -->
                </div> <!-- /.col-md-12 -->
                            ...
                            <div class="card questionCard">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body">
                                        ...
                                        النشر. كان لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن الخامس عشر عندما
