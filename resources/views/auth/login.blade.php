    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-7 pages">
                <div class="list-menu">
                    <h2 class="pagetitle">تسجيل دخول</h2>
                    <ul>
                        <li><a class="active" href="/">الرئيسية <span class="inActive">/</span></a></li>
                        <li><a class="inActive">تسجيل دخول</a></li>
                    </ul>
                </div> <!-- /.list-menu -->
            </div> <!-- /.col-md-12 -->
        ...
        <div class="col-md-12 Regcard">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <h4 class="title"><i class="fa fa-user"></i> تسجيل دخول </h4>
                    <hr>
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row row-space">
                            <div class="col-md-12">
                                <div class="input-group row">
                                    <label class="label col-md-5">البريد الإلكتروني <span>*</span>:
                                    </label>

                                    <input id="email" type="email" class="input--style-4 col-md-7 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                            ...
                            <div class="col-md-12">
                                <div class="input-group row">
                                    <label class="label col-md-5">كلمة المرور <span>*</span>:
                                    </label>

                                    <input id="password" type="password" class="input--style-4 col-md-7 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                        ...
                        <div class="row row-space">
                            <div class="col-md-12">
                                <div class="input-group row">
                                    <label class="label col-md-7">&nbsp;</label>
                                    <label class="label col-md-5">
                                        <a class="forgetPassword" href="{{ route('password.request') }}">نسيت كلمة المرور؟</a>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="p-t-15 submitContaier">
                            ...
                            <button class="btn btn--radius-2 btn--blue submit" type="submit">تسجيل دخول</button>
                        </div>
                    </form>

                    <hr>
                    <div style="text-align: center">
                        <a class="btn btn--radius-2 btn--blue submit reg"> <i class="fa fa-user-plus"></i> تسجيل
                            حساب جديد </a>
